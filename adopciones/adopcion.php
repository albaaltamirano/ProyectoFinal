...
<body>
    ...
    <section class="card">
        ...
        <article class="card-ficha" id="dani">
            <img src="../Assets/Adopciones/DaniMalón.jpg" alt="Anita" title="DaniMalón" style="cursor:pointer"
        ...
        <article class="card-ficha" id="negro">
            <img src="../Assets/Adopciones/Negro.jpg" alt="Negro" title="ANITA" style="cursor:pointer"
                onclick="onClick(this)" class="w3-hover-opacity">
            <div class="card-txt">
                <h3>Negro</h3>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nesciunt non dicta possimus ad magni
    ...
    <a href="https://api.whatsapp.com/send?phone=543493461833" rel="" title="WhatsApp">
        ...
        <footer>
            <div class="footer-contacto">
              <div class="footer-contacto form">
                ...
                <form class="contacto" id="FormId">
                  ...
                  <input class="contacto-input" type="text" name="nombre" id="nombre">
                  <br>
                  <label class="contacto-label" for="email"> Email </label>
                  <input class="contacto-input" type="email" name="email" id="email">
                  <br>
                  <label class="contacto-label" for="telefono"> Teléfono</label>
                  <input class="contacto-input" type="text" name="telefono" id="telefono">
                  <br>
                  <textarea class="contacto-mensaje" rows="6" cols="40" placeholder="Mensaje"></textarea>
                  <br>
                ...
                <h3>Contacto</h3>
                  <div class="footer-contacto txt">
                    <ul>
                      ...
                      <li><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
            ...
            <div class="footer-final">
              ...
              <h4> Copyright © 2023 Proyecto Rescata. Todos los derechos reservados. </h4>
